...
print("Time Taken to solve TSP using Held-Karp [%s seconds]" % (time.time() - start_time))
...
ListOfCities[0].generateOverallPN_Graph(cityNamelist,positiveValuelist,negativeValuelist);
...
print("\n\nCities and their Sentiment Value")
...
print("The Shortest path ("+str(round(costTPS,3))+" km):")
print(final_shortestPath)
print("")

print("The Sentiment Value path ("+str(round(sv_distance,3))+" km):")
print(final_sentimentPath)
print("")
